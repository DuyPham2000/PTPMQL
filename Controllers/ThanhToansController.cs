...
namespace PTPMQL.Controllers
{
    ...
    public class ThanhToansController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "PhongNghi,TienPhong,TienAn,TienGiaiTri")] ThanhToan thanhToan)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "PhongNghi,TienPhong,TienAn,TienGiaiTri")] ThanhToan thanhToan)
        {
            if (ModelState.IsValid)
            {
        ...
        private void CopyDataByBulk(DataTable dt)
        {
            ...
            bulkcopy.DestinationTableName = "ThanhToans";
            bulkcopy.ColumnMappings.Add(0, "PhongNghi");
            bulkcopy.ColumnMappings.Add(1, "TienPhong");
            bulkcopy.ColumnMappings.Add(2, "TienAn");
            bulkcopy.ColumnMappings.Add(3, "TienGiaiTri");
            con.Open();
