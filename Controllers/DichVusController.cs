...
namespace PTPMQL.Controllers
{
    ...
    public class DichVusController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "PhongNghi,DoAn,GiaiTri")] DichVu dichVu)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "PhongNghi,DoAn,GiaiTri")] DichVu dichVu)
        {
            if (ModelState.IsValid)
            {
